...
- [Phase 09-03]: MeetingLandingPage defines local MeetingLandingUser interface with workflowGroups?: string[] to avoid coupling to AuthUser which lacks that field in parallel worktree
- [Phase 09-03]: OfficerInfoForm duplicates participant management logic (addParticipant/updateParticipant/removeParticipant) per D-04 independence rule — no cross-form coupling with MeetingInfoForm
...
| Phase 09-ui-revamp-website-va-giao-dien-tung-nhom-tinh-nang P09-03 | 2min | 2 tasks | 3 files |
